<?php
  ...
  if(isset($_GET['id'])&& is_numeric($_GET['id'])) {
    ...
    // preparação da consulta no back-end
     ...
     if ($dado['status'] =='success'){
      ...
      $fk_generos = $arrNoticia['fk_generos'];
  ...
  $generos_json = file_get_contents($end_point);
  $generos = json_decode($generos_json, true);
              ...
              <div class="card-body">
                <form action="salvar.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="noticia">Generos: </label>
                      <select name="fk_generos" id="fk_generos" placeholder="selecione o Genero da Noticia" class="form-control">
                        <?php
                         foreach($generos as $genero){

                          $selected = "";
                          if($fk_generos == $genero['pk_id']) {
                            $selected = "selected";
                          }

                          echo "<option $selected value='" . $genero['pk_id'] . "'>" . $genero['tipo_genero'] . "</option>";
                          }
                        ?>
