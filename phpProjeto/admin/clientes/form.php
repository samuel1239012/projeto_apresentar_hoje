...
$arrCliente = $dado["clientes"];
 
 
    if ($dado['status']=='success'){
      $email = $arrCliente["email"];
      $nome = $arrCliente["nome"];
      $whatsapp = $arrCliente["whatsapp"];
      $imagem = $arrCliente['imagem'];
      // $cpf = $arrCliente["cpf"];

    }
    if(!empty($arrCliente["imagem"])){
      $img =$comp."../".$arrCliente["imagem"];
    }
                ...
                <form action="salvar.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">  
                      ...
                      <input type="text" id="nome" name="nome" value="<?php echo $nome ? $arrCliente["nome"] : ""  ?>" class="form-control" placeholder="Nome">
                    </div>                
                    <!-- <div class="form-group">
                      <label for="cpf">CPF</label>
                      <input type="number" id="cpf" name="cpf" value="<?php echo $cpf ? $arrCliente["cpf"] : ""  ?>" class="form-control" placeholder="CPF">
                    </div>                 -->
                    <div class="form-group">  
                      <label for="whatsapp">Whatsapp</label>
                      <input type="number" id="whatsapp" name="whatsapp" value="<?php echo $whatsapp ? $arrCliente["whatsapp"] : ""  ?>" class="form-control" placeholder="Numero">
                    </div>                
                    <div class="form-group">  
                      <label for="email">E-mail</label>
                      <input type="text" id="email" name="email" value="<?php echo $email ? $arrCliente["email"] : ""  ?>" class="form-control" placeholder="E-mail">
                    </div>                
                    <div class="form-group">  
